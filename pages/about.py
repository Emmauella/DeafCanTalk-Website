...
def about_page():
    ...
    with ui.element('div').classes('hero-section'):
        ui.label('About DeafCanTalk').classes('text-5xl font-bold mb-4')
        ui.label('Our mission is to empower the deaf and hard-of-hearing community').classes('text-xl text-gray-200')
    
    # Mission section
    with ui.element('div').classes('section'):
        ui.label('Our Mission').classes('text-4xl font-bold text-[#003366] mb-6')
    ...
    with ui.element('div').classes('section bg-gray-50'):
        with ui.row().classes('w-full items-center gap-8 flex-wrap'):
            with ui.column().classes('flex-1'):
                ui.image('/assets/ojWfYsq24CjA.jpg').classes('rounded-lg shadow-lg w-full').style('max-width: 500px;')
    ...
    with ui.element('div').classes('section bg-gray-50'):
        ...
        with ui.row().classes('w-full gap-6 flex-wrap justify-center'):
            ...
            with ui.element('div').classes('card').style('flex: 1; min-width: 250px; max-width: 300px; text-align: center;'):
                ui.label('Sarah Johnson').classes('text-xl font-bold text-[#003366] mb-2')
            ...
            # Team member 2
            with ui.element('div').classes('card').style('flex: 1; min-width: 250px; max-width: 300px; text-align: center;'):
                ui.label('Michael Chen').classes('text-xl font-bold text-[#003366] mb-2')
                ui.label('Lead Developer').classes('text-md text-[#0066cc] mb-3')
            ...
            # Team member 3
            with ui.element('div').classes('card').style('flex: 1; min-width: 250px; max-width: 300px; text-align: center;'):
                ui.label('Emily Rodriguez').classes('text-xl font-bold text-[#003366] mb-2')
                ui.label('Education Director').classes('text-md text-[#0066cc] mb-3')
    ...
    with ui.element('div').classes('section'):
        ...
        with ui.row().classes('w-full gap-8 flex-wrap justify-center items-center'):
            with ui.element('div').classes('card').style('flex: 1; min-width: 200px; max-width: 250px; text-align: center;'):
                ui.label('50,000+').classes('text-5xl font-bold text-[#FFD700] mb-2')
                ui.label('Active Users').classes('text-lg text-gray-700')
            
            with ui.element('div').classes('card').style('flex: 1; min-width: 200px; max-width: 250px; text-align: center;'):
                ui.label('100+').classes('text-5xl font-bold text-[#FFD700] mb-2')
                ui.label('Educational Resources').classes('text-lg text-gray-700')
            
            with ui.element('div').classes('card').style('flex: 1; min-width: 200px; max-width: 250px; text-align: center;'):
                ui.label('25').classes('text-5xl font-bold text-[#FFD700] mb-2')
